...
class weekElasticSortController extends Controller
{
    public function filterweekonly(Request $request) {
        $from = $request->from;
        $to = $request->to;
    ...
    public function filterweekloadingsite(Request $request) {
        $from = $request->from;
        $to = $request->to;
    ...
    public function filterweekproduct(Request $request) {
        $from = $request->from;
        $to = $request->to;
    ...
    public function filterweeklyfullcriteria(Request $request) {
        $from = $request->from;
        $to = $request->to;
        $loading_site_id = $request->loading_site_id;
        $product_id = $request->product_id;
