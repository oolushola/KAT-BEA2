...
class yearElasticSortController extends Controller
{
    public function filterYearOnly(Request $request) {
        $year = $request->choosen_year;
        $orders = $this->tripQueryBuilder($year, 'year');
    ...
    public function filterYearandMonth(Request $request) {
        $month = $request->month;
        $year = $request->choosen_year;
        $orders = $this->tripQueryfortwofieldNames($year, 'month', $month);
        $tripWaybills = tripWaybill::GET();
        $tripEvents = tripEvent::ORDERBY('current_date', 'DESC')->GET();
        $waybillstatuses = tripWaybillStatus::GET();
    ...
    public function filterYearandClient(Request $request) {
        $client_id = $request->client_id;
        $year = $request->choosen_year;
        $orders = $this->tripQueryfortwofieldNames($year, 'client_id', $client_id);
        $tripWaybills = tripWaybill::GET();
        $tripEvents = tripEvent::ORDERBY('current_date', 'DESC')->GET();
        $waybillstatuses = tripWaybillStatus::GET();
    ...
    public function filterYearandLoadingsite(Request $request) {
        $loading_site_id = $request->loading_site_id;
        $year = $request->choosen_year;
        $orders = $this->tripQueryfortwofieldNames($year, 'loading_site_id', $loading_site_id);
        $tripWaybills = tripWaybill::GET();
        $tripEvents = tripEvent::ORDERBY('current_date', 'DESC')->GET();
        $waybillstatuses = tripWaybillStatus::GET();
    ...
    public function filterYearTransporter(Request $request) {
        $transporter_id = $request->transporter_id;
        $year = $request->choosen_year;
        $orders = $this->tripQueryfortwofieldNames($year, 'transporter_id', $transporter_id);
        $tripWaybills = tripWaybill::GET();
        $tripEvents = tripEvent::ORDERBY('current_date', 'DESC')->GET();
        $waybillstatuses = tripWaybillStatus::GET();
    ...
    public function filterYearProduct(Request $request) {
        $product_id = $request->product_id;
        $year = $request->choosen_year;
        $orders = $this->tripQueryfortwofieldNames($year, 'product_id', $product_id);
        $tripWaybills = tripWaybill::GET();
        $tripEvents = tripEvent::ORDERBY('current_date', 'DESC')->GET();
        $waybillstatuses = tripWaybillStatus::GET();
    ...
    public function filterYearState(Request $request) {
        $state_id = $request->state_id;
        $year = $request->choosen_year;
        $orders = $this->tripQueryfortwofieldNames($year, 'destination_state_id', $state_id);
        $tripWaybills = tripWaybill::GET();
        $tripEvents = tripEvent::ORDERBY('current_date', 'DESC')->GET();
        $waybillstatuses = tripWaybillStatus::GET();
        ...
        $answer = '<select class="form-control" id="yearExactLocation">
                        <option value="0">Exact Location</option>';
        $exactLocationListings = transporterRate::SELECT('id', 'transporter_destination')->WHERE('transporter_to_state_id', $state_id)->GET();
            foreach($exactLocationListings as $exactlocation) {
                $answer.='<option value="'.$exactlocation->id.'">'.$exactlocation->transporter_destination.'</option>';
            }
        $answer.='</select>';

        return $tabledata.'`'.$answer;        
