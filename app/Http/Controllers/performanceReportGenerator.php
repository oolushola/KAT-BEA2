        ...
        foreach($teammembers as $key=> $member) {
            ...
            $result.='<table class="table mb-4">
                ...
                foreach ($distinctClient as $key => $client) {
                    ...
                    $netMargin = $tripRevenue[0]->revenue - $tripsCost[0]->cost;
                    ...
                    $result.='
                        <tr>
                            ...
                            <td class="text-center">'.number_format($tripRevenue[0]->revenue + $incentive, 2).'</td>
                ...
                $result.='
                    <tr class="bg-info-400 font-weight-bold">
                        ...
                        <td class="text-center">&#x20A6;'.number_format($sumRevenue, 2).'</td>
                        <td class="text-center">&#x20A6;'.number_format($sumCost, 2).'</td>
                        <td class="text-center">&#x20A6;'.number_format($sumRevenue - $sumCost, 2).'</td>
                    </tr>
                </tbody>';
